document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    const res = await fetch(`https://corsproxy.io/?https://universe-api-uabt.onrender.com/api/products/id/${productId}`);
    ...
    const relRes = await fetch(`https://corsproxy.io/?https://universe-api-uabt.onrender.com/api/products/category/${encodeURIComponent(product.productCategory)}`);
